...
Figure 4 - The relationship between the number of input tokens and the number of LLM calls. 
One SWE-Bench task instance is selected from each of AutoCodeRover, OpenHands, and SWE-agent as a showcase. 
</h6>
