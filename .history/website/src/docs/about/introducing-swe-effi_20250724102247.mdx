...
To capture the fine-grained data for our analysis, we augmented each agent's logging and added our own profiling code to collect the precise time cost regarding local CPU computation and the backend LLM inference for each agent scaffold.
...
[1]: https://www.together.ai/blog/deepswe "DeepSWE: Training a Fully Open-sourced, State-of-the-Art Coding Agent by Scaling RL"
[2]: https://github.com/NovaSky-AI/SkyRL "SkyRL: A Modular Full-stack RL Library for LLMs"
[3]: https://github.com/AutoCodeRoverSG/auto-code-rover "Autocoderover: Autonomous program improvement"
[4]: https://github.com/OpenAutoCoder/Agentless "Agentless: Demystifying LLM-based Software Engineering Agents"
[5]: https://github.com/facebookresearch/swe-rl "SWE-RL: Advancing LLM Reasoning via Reinforcement Learning on Open Software Evolution"
[6]: https://github.com/All-Hands-AI/OpenHands "OpenHands: Code Less, Make More"
[7]: https://github.com/SWE-agent/SWE-agent "SWE-agent: Agent-Computer Interfaces Enable Automated Software Engineering"