...
[1] [DeepSWE: Training a Fully Open-sourced, State-of-the-Art Coding Agent by Scaling RL](https://www.together.ai/blog/deepswe)
[2] [SkyRL: A Modular Full-stack RL Library for LLMs](https://github.com/NovaSky-AI/SkyRL)
[3] [Autocoderover: Autonomous program improvement](https://github.com/AutoCodeRoverSG/auto-code-rover)
[4] [OpenHands: Code Less, Make More](https://github.com/All-Hands-AI/OpenHands)
[5] [SWE-agent: Agent-Computer Interfaces Enable Automated Software Engineering](https://github.com/SWE-agent/SWE-agent)
